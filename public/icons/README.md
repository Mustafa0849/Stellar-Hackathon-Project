...
This directory contains the icon files for the Nova Wallet Chrome extension.
...
The `icon.svg` file has been created with the Nova Wallet logo design. To convert it to PNG files at the required sizes:
...
- **"NOVA" text** below the shield in matching teal color
